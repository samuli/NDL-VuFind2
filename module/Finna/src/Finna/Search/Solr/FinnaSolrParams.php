...
trait FinnaSolrParams
{
    ...
    protected $SPATIAL_DATERANGE_FIELD_VF1 = 'search_sdaterange_mv';
    protected $SPATIAL_DATERANGE_FIELD_TYPE_VF1 = 'search_sdaterange_mvtype';
    ...
    public function addFilter($filter)
    {
        ...
        if ($field == $this->getDateRangeSearchField()
            || $field == $this->SPATIAL_DATERANGE_FIELD_VF1
        ) {
    ...
    public function initSpatialDateRangeFilter($request)
    {
        ...
        if (!$type) {
            // VuFind 1
            $type = $request->get($this->SPATIAL_DATERANGE_FIELD_TYPE_VF1);
        }
        if (!$type) {
            $type = 'overlap';
        }
